        ...
        if ($this->owner->hasMethod('supportsElemental') && $this->owner->supportsElemental()) {
            ...
            if($elementalArea->exists()) {
                ...
                if($elementControllers->Count()) {
                    ...
                    Requirements::javascript('sunnysideup/silverstripe-elemental-style:client/dist/javascript/uikit-icons.custom.min.js');
                    Requirements::javascript('sunnysideup/silverstripe-elemental-style:client/dist/javascript/main.js');
                    Requirements::css('sunnysideup/silverstripe-elemental-style:client/dist/css/main.css');
